...
const Construc = () => {
    ...
    return (
        <div className="bg-red-600">
            {
                projectCurrent &&
                <Constructor setOpenelements={setOpenelements} openelements={openelements} nameFile={projectCurrent} arr={arr} setArr={setArr}/>
            }
                <div
                ...
                <div
                    className=" content-center right-28 top-1 hover:bg-gray-400 cursor-pointer absolute border-4 border-indigo-400 rounded-2xl w-8 h-8 "
